...
## 📜 Actividad: Manifiesto de IA para mi profesión

Equipos de 4–5 de la misma carrera, en un tablero de **Miro** compartido:

1. **Lluvia:** con *sticky notes*, listen usos de IA en su profesión en tres columnas: ✅ siempre bien · ⚠️ depende · ❌ nunca.
2. **Abogado del diablo:** pídanle a Gemini: *"Eres un crítico duro. Da los 5 mejores argumentos en contra de nuestro manifiesto: [pegar columnas]."* Respondan a cada argumento o muevan la nota de columna.
3. **Redacción:** 7 principios, máximo 2 líneas cada uno. Usen la IA de Miro para resumir y agrupar, pero la redacción final es de ustedes.
4. **Compromiso:** un principio que apliquen **en este curso** desde hoy.
...
**Sustentación:** en parejas de carreras distintas. Tu compañero le hace 3 preguntas a tu asistente: una que está en tus fuentes, una que no está, y una trampa. Tú explicas qué hizo bien, qué falló y cómo lo ajustarías en vivo.
