...
**Verificación cruzada:** sube el mismo CSV a Claude o ChatGPT y haz la pregunta 1. ¿Coinciden los números? Si no, ¿quién tiene razón? (Pista: mira el código.)
...
## 🧗 Ruta pro: analizar una carpeta con un agente
