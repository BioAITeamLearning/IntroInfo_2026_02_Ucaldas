...
## 🧠 ¿Qué es la IA? (lo mínimo)

Quick Draw adivina tus dibujos porque **le mostraron 50 millones de dibujos de otras personas**. Nadie le explicó qué es un gato. Esa es la idea central de la IA moderna: **aprender de ejemplos, no de reglas**.
...
## 🎩 10 superpoderes que vas a ver hoy

Diez cosas que la IA ya hace por un biólogo, un abogado, un artista o un deportólogo. Hoy las ves; en el resto del curso las haces tú.

| # | Superpoder | Herramienta | Ejemplo |
|---|---|---|---|
...
| 6 | **Analizar una carpeta entera** | Gemini CLI en la terminal | "Lee estos 30 PDFs y dime cuáles hablan de X" (Sesión 14) |
| 7 | **Hacer una app desde una hoja de cálculo** | AppSheet | Inventario del laboratorio → app en el celular en 3 min (Sesión 9) |
...
5. Escucha el primer minuto del podcast. ¿Dijo algo que no está en tus fuentes?
